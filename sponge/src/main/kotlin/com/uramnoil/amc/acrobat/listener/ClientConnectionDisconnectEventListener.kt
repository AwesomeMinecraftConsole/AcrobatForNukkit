...
class ClientConnectionDisconnectEventListener(private val controller: SendOnlinePlayersController, private val service: GetOnlinePlayersService) : EventListener<ClientConnectionEvent.Disconnect> {
